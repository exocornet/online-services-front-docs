...
![stage1](includes-images-readme/components-project/SigningConditions/MoeskSigningConditions-browser.jpg "Этап №1")

> В коде за 1-ый этап у сервиса **НПО-КПП - МОЭСК (Россети)** отвечает компонент `MoeskSigningConditions`. В данном компоненте находится вся отображаемая верстка и JS логика 1-ого этапа.

![MoeskSigningConditions](includes-images-readme/components-project/SigningConditions/MoeskSigningConditions-code.jpg "компонент MoeskSigningConditions")
...
![Scenario.json](includes-images-readme/10-services-moesk/services-moesk-1.jpg "вызов компонентов 2-ого этапа")
...
![stage3](includes-images-readme/10-services-moesk/services-moesk-2.jpg "Этап №3")

> В коде за 3-ий этап у сервиса **НПО-КПП - МОЭСК (Россети)** отвечает компонент `MoeskAgreementTerms`. В данном компоненте находится вся отображаемая верстка и JS логика 3-го этапа.

![MoeskAgreementTerms](includes-images-readme/components-project/AgreementTerms/MoeskAgreementTerms-code.jpg "компонент MoeskAgreementTerms")
...
> В коде за 4-ий этап у сервиса **НПО-КПП - МОЭСК (Россети)** отвечает компонент `VerifyMobile`. В данном компоненте находится вся отображаемая верстка и JS логика 4-ого этапа.
...
> В коде за 5-ий этап у сервиса **НПО-КПП - МОЭСК (Россети)** отвечает компонент `PrefilledContract`. В данном компоненте находится вся отображаемая верстка и JS логика 5-ого этапа.
...
> В коде за 7-ий этап у сервиса **НПО-КПП - МОЭСК (Россети)** отвечает компонент `RusgidroDownloadDocs`. В данном компоненте находится вся отображаемая верстка и JS логика 7-ого этапа.
